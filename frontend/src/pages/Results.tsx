  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-16">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-xl text-primary-foreground mt-4 animate-slide-in-left animation-delay-200">
              <span className="font-semibold text-accent">Confucius</span> is here to explain, clarify, and help you learn.
            </p>
          </div>
        ...
        {/* Confucius Avatar */}
        <div className="fixed bottom-8 right-8 flex flex-col items-center gap-2 animate-fade-in animation-delay-500 group cursor-pointer">
          ...
          <div className="relative">
            <img 
              ...
              className="w-32 h-auto rounded-2xl shadow-card group-hover:shadow-xl transition-all duration-300 group-hover:scale-105 relative z-10"
            />
