        ...
        <div className="flex-1 flex flex-col px-36 pb-16">
          ...
          <div className="mb-12 animate-fade-in">
            ...
            <p className="text-xl text-primary-foreground mt-4 animate-slide-in-left animation-delay-200">
              <span className="font-semibold">Confucius</span> is here to explain,
              clarify, and help you learn.
            </p>
          </div>
          ...
          <div className="w-full max-w-4xl mt-12 relative flex items-center justify-right">
            {/* Center text */}
            <div className="w-full max-w-8xl mt-10 flex items-center justify-between"></div>
